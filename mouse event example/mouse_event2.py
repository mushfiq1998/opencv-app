...
while(cap.isOpened()):
    ...
    if ret == True:
        ...
        '''img = cv2.putText(img, 'text', (coordinate of starting point), 
        font, fontSize, (color in BGR format), thikness, fontType)'''
...
Release or close the video capture from the device that you have opened for reading video 
frames.'''
cap.release()
