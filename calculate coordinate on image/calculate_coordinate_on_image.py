...
background_img = cv2.imread('stadium4.jpeg')
...
football_img_resized2 = cv2.resize(football_img, (target_region2_width, target_region2_height))
background_img[top_left_y2:bottom_right_y2, top_left_x2:bottom_right_x2] = football_img_resized2
